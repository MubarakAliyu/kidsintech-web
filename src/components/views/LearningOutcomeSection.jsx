  ...
  return (
    <section className="bg-[#F6F8DC] px-4 sm:px-8 lg:px-[160px] py-12 sm:py-16 lg:py-[96px]">
      <article className="container flex flex-col items-center gap-6 sm:gap-8 relative">
        {/* HEADER */}
        <Image src={Heading} alt="Heading" width={496} height={119} className="lg:w-[496px] w-[352px] lg:h-[119px] h-auto lg:object-cover object-contain" />

        {/* Decorative Arrow 1 - Points to title */}
        <div className="hidden lg:block absolute -top-[18%] right-[58%]">
        ...
        <div className="flex flex-col items-start  sm:-gap-4 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-0 w-full  relative">
            <div className="flex justify-start items-center gap-2 sm:gap-3 lg:gap-4 rounded-2xl sm:rounded-3xl lg:rounded-4xl bg-[#2D2124] px-4 sm:px-6 lg:px-7 py-4 sm:py-5 lg:py-6">
              <Image
                src={TechCreativity}
                alt="Tech Creativity"
                width={32}
              ...
              />
              <p className="text-base md:text-lg lg:text-xl text-white leading-4 sm:leading-5 lg:leading-[26px]">
            ...
            <div className="flex justify-start items-center gap-2 sm:gap-3 lg:gap-4 rounded-2xl sm:rounded-3xl lg:rounded-4xl bg-[#2D2124] px-4 sm:px-6 lg:px-7 py-4 sm:py-5 lg:py-6">
              <Image
                ...
                className="w-6 h-6 sm:w-8 sm:h-8 lg:w-[32px] lg:h-[32px]"
              />
              <p className="text-base md:text-lg lg:text-xl text-white leading-4 sm:leading-5 lg:leading-[26px]">Confidence & Expression</p>
            </div>
            <div className="flex justify-start items-center gap-2 sm:gap-3 lg:gap-4 rounded-2xl sm:rounded-3xl lg:rounded-4xl bg-[#2D2124] px-4 sm:px-6 lg:px-7 py-4 sm:py-5 lg:py-6">
              <Image
                ...
                className="w-6 h-6 sm:w-8 sm:h-8 lg:w-[32px] lg:h-[32px]"
              />
              <p className="text-base md:text-lg lg:text-xl text-white leading-4 sm:leading-5 lg:leading-[26px]">Collaboration & Fun</p>
            </div>
          </div>
