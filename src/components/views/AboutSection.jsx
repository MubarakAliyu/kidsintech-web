    ...
    <section className="bg-[#EDF4D6] px-4 sm:px-8 lg:px-[160px] py-12 sm:py-16 lg:py-[96px]">
      <article className="container flex flex-col items-center gap-6 sm:gap-8 relative">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6 lg:gap-8">
          {/* Left Image */}
          <figure className="w-full lg:w-[30%] rounded-2xl overflow-hidden cursor-pointer group transform transition-transform duration-300 ease-in-out hover:scale-105">
            <Image src={AboutSectionImg1} alt="Gallery image 1" className="w-full h-full object-cover" placeholder="blur" />
          </figure>

          {/* Text Content */}
          <div className="flex flex-col items-center text-center gap-4 w-full lg:w-[60%]">
          ...
          {/* Right Image */}
          <figure className="w-full lg:w-[30%] rounded-2xl overflow-hidden cursor-pointer group transform transition-transform duration-300 ease-in-out hover:scale-105 mt-6 lg:mt-0">
