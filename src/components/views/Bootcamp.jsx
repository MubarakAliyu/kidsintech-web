    ...
    <section id="design-stem" className="bg-[#FFF7F1] px-4 sm:px-8 lg:px-[160px] py-12 sm:py-16 lg:py-[96px]">
      <article className="container flex flex-col items-center gap-6 sm:gap-8 relative">
        ...
        <div className="flex flex-col gap-6 relative">
          <h2 className="text-center text-[43px] sm:text-4xl md:text-5xl lg:text-[68px] font-bold text-[#F6DC74] text-shadow-[6px_3px_0px_#422110] leading-10 md:leading-[50px]">
            Designing and <br />
            <span className="text-[#95CAD2]">STEM Learning</span> <br />
            <span className="text-[#DBD5C4] ml-4">Bootcamp</span>
          </h2>
        </div>
